  ...
  return (
    <div>
      <div className="relative group flex items-center justify-center h-auto w-full rounded-xl p-4 hover:bg-slate-900 hover:dark:bg-slate-400 shadow-xl shadow-gray-400">
        ...
        />
        <div className="hidden items-center group-hover:block absolute top-[50%] translate-x-[-50%] translate-y-[-50%] left-[50%] ">
          ...
          <Link href={projectUrl}>
            <button className="justify-center w-full text-center p-4 rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer dark:bg-slate-800 dark:text-white">
              More Info
            </button>
          </Link>
        </div>
